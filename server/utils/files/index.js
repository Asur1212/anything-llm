...
// Fallback storage path for production if STORAGE_DIR is not set
const storageBasePath =
  process.env.NODE_ENV === "development"
    ? path.resolve(__dirname, "../../storage")
    : process.env.STORAGE_DIR || "/app/server/storage";

const documentsPath = path.resolve(storageBasePath, "documents");
const vectorCachePath = path.resolve(storageBasePath, "vector-cache");
